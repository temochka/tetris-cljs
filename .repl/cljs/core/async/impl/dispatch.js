...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_15084 = 0;while(true){
var m_15085 = cljs.core.async.impl.dispatch.tasks.pop();if((m_15085 == null))
{} else
{m_15085.call(null);
if((count_15084 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__15086 = (count_15084 + 1);
count_15084 = G__15086;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__6192__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__6192__auto__)
