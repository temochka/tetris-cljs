...
goog.require('goog.events');
clojure.browser.event.IEventType = (function (){var obj11552 = {};return obj11552;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__6053__auto__ = this$;if(and__6053__auto__)
...
{var x__6692__auto__ = (((this$ == null))?null:this$);return (function (){var or__6065__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__6692__auto__)]);if(or__6065__auto__)
{return or__6065__auto__;
} else
{var or__6065__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__6065__auto____$1)
...
return (function (p__11555){var vec__11556 = p__11555;var k = cljs.core.nth.call(null,vec__11556,(0),null);var v = cljs.core.nth.call(null,vec__11556,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__11557){var vec__11558 = p__11557;var k = cljs.core.nth.call(null,vec__11558,(0),null);var v = cljs.core.nth.call(null,vec__11558,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
