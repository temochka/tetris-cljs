...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_13106 = 0;while(true){
if((i_13106 < arr.length))
{(arr[i_13106] = null);
{
var G__13107 = (i_13106 + 1);
i_13106 = G__13107;
continue;
}
} else
...
{var i_13113 = (self__.level + 1);while(true){
if((i_13113 <= (new_level + 1)))
{(update[i_13113] = self__.header);
{
var G__13114 = (i_13113 + 1);
i_13113 = G__13114;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_13115 = 0;while(true){
if((i_13115 <= self__.level))
{var links_13116 = (update[i_13115]).forward;if(((links_13116[i_13115]) === x__$1))
{(links_13116[i_13115] = (x__$1.forward[i_13115]));
{
