...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_13197 = 0;while(true){
var m_13198 = cljs.core.async.impl.dispatch.tasks.pop();if((m_13198 == null))
{} else
{m_13198.call(null);
if((count_13197 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__13199 = (count_13197 + 1);
count_13197 = G__13199;
continue;
}
} else
{}
