...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__4048__auto__,writer__4049__auto__,opt__4050__auto__){return cljs.core._write(writer__4049__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_13179 = 0;while(true){
if((i_13179 < arr.length))
{(arr[i_13179] = null);
{
var G__13180 = (i_13179 + 1);
i_13179 = G__13180;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__4048__auto__,writer__4049__auto__,opt__4050__auto__){return cljs.core._write(writer__4049__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_13186 = (self__.level + 1);while(true){
if((i_13186 <= (new_level + 1)))
{(update[i_13186] = self__.header);
{
var G__13187 = (i_13186 + 1);
i_13186 = G__13187;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.cljs$core$IFn$_invoke$arity$4(self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_13188 = 0;while(true){
if((i_13188 <= self__.level))
{var links_13189 = (update[i_13188]).forward;if(((links_13189[i_13188]) === x__$1))
{(links_13189[i_13188] = (x__$1.forward[i_13188]));
{
var G__13190 = (i_13188 + 1);
i_13188 = G__13190;
continue;
}
} else
{{
var G__13191 = (i_13188 + 1);
i_13188 = G__13191;
continue;
}
}
...
cljs.core.async.impl.dispatch.queue_delay(((function (timeout_channel,or__3481__auto__,timeout__$1,me){
