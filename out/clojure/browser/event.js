...
goog.require('goog.events');
clojure.browser.event.EventType = (function (){var obj13446 = {};return obj13446;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__5977__auto__ = this$;if(and__5977__auto__)
...
{var x__6616__auto__ = (((this$ == null))?null:this$);return (function (){var or__5989__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__6616__auto__)]);if(or__5989__auto__)
{return or__5989__auto__;
} else
{var or__5989__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__5989__auto____$1)
...
return (function (p__13447){var vec__13448 = p__13447;var k = cljs.core.nth.call(null,vec__13448,0,null);var v = cljs.core.nth.call(null,vec__13448,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__13449){var vec__13450 = p__13449;var k = cljs.core.nth.call(null,vec__13450,0,null);var v = cljs.core.nth.call(null,vec__13450,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
